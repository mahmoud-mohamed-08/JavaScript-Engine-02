...
function updateAndDraw() {
    ...
    if (inp.inputs.lclick && shapeBeingMade == null) {
        ...
        if (shapeSelected == 'c') {
            ...
            shapeBeingMade = new Rect(inp.inputs.mouse.position.clone(), SMALLEST_RADIUS*2, SMALLEST_RADIUS*2, inp.colorSelected);    //remember to add input colorSelected when you make the new rectangle because you changed the constructor of Rect class
        }
